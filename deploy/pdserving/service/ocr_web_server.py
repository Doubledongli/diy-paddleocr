...
from deploy.paddle_serving_server.web_service import WebService
...
class OCRService(WebService):
    ...
    def preprocess(self, feed=[], fetch=[]):
        image_url = BytesIO(requests.get(feed[0]["image"]).content).read()
        data = base64.b64encode(image_url)
        ...
        return feed, fetch, True, dt_boxes

    def postprocess(self, feed={}, fetch=[], fetch_map=None, dt_boxes=[]):
        ...
        for box, (text, score) in zip(dt_boxes, rec_res):
            ...
            result = {
                ...
                "locations": {
                    ...
                    "height": int(box[2][1]) - int(box[0][1])
                }
            }
